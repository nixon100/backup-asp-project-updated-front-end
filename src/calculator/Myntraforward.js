...
const Myntraforward = () => {
  ...
  useEffect(() => {
    async function fetchData0() {
      try {
        const response = await axios.get("http://localhost:8800/myncom");
      ...
      <div className="gamut-14z39fp-LayoutGrid 14g39">
        {formData.xcv && (
          <div className="form-example1">
            <label className="myntra"for="data0">Enter MRP: </label>
            <input
              type="text"
              name="data0"
              id="0011"
            ...
            <label className="myntra"for="data1">Enter Discount: </label>
            <input
              type="text"
              name="data1"
              id="0011"
        ...
        <div className="form-example">
          ...
          <label className="myntra"for="data3">Enter ASP: </label>
          <input
            type="text"
            name="data3"
            id="0011"
        ...
        <div className="form-example">
          <label className="myntra"for="data2">Enter Customer Returns: </label>
          <input
            type="text"
            name="data2"
            id="0011"
        ...
        <div className="form-example">
          <label className="myntra"for="dataB">Brand:</label>
          <select
            name="dataB"
            id="dataB"
        ...
        <div className="form-example">
          <label className="myntra"for="dataG">Gender:</label>
          <select
            name="dataG"
            id="dataB"
        ...
        <div className="form-example">
          <label className="myntra"for="dataG">Category:</label>
          <select
            name="dataG"
            id="dataB"
        ...
        <div className="form-example">
          <label className="myntra"for="dataPV">Payment Receipt: </label>
          <input
            type="number"
            name="dataPV"
            id="0011"
